...
class ORMFixture:
    ...
    class ORMContact(db.Entity):
        ...
        # сейчас данная строчка бесполезна
    ...
    def __init__(self, host, name, user, password):
        ...
        # пример из видео, чтобы работало if c.deprecated is None (чтобы правильно распознавалось 0000-00-00 00:00:00)
        # self.db.bind('mysql', host=host, database=name, user=user, password=password, conv=decoders)
        # сопоставление свойств классов, описанных выше
